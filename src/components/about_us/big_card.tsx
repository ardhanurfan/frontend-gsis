...
const BigCard = ({name, title, jabatan, paragraph, foto}: BigCardProps) =>{
    return(
      <div className="w-[90.3vw] max-w-[1300px] h-[auto] lg:h-[615px] overflow-auto lg:overflow-visible bg-slate-100 bg-opacity-30 rounded-xl mx-auto mt-[120px] lg:mt-[250px] shadow-lg shadow-slate-500 flex flex-col lg:flex-row gap-[30px] lg:gap-[65px]">
        ...
        <div className="lg:pt-[98px] w-full clear-left lg:clear-none">
          <h1 className="text-primaryText header1-mobile lg:header1 text-center lg:text-start px-12 lg:px-0 lg:pr-2 mb-[37px]">
            {title}
          </h1>
