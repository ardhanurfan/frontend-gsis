...
function TimelineItem({ orientation, date, dateDetail, eventDesc, eventName, className }: TimelineItemProps) {
    return (
        <div className={clsx('relative flex w-[40rem] mx-auto items-center', orientation === "right" && 'flex-row-reverse right-6', className)}>
            <div className={clsx('absolute text-center top-20', orientation == "left" && 'left-[50px]', orientation == "right" && 'right-[50px]')}>
