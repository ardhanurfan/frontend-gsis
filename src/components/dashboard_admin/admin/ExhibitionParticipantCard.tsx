          ...
          <div className="pb-5 xl:py-5 px-5">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-8 my-5">
              <div className="flex flex-col w-auto">
                <p className="text-[#015CBA] body-text">Stream</p>
              ...
              <div>
                <div className="flex flex-row gap-1 w-[150px]">
                  <a
                    href={row.documentation[row.documentation.length - 1].url}
                    className="text-[#FCFCFC] button-text-mobile sm:button-text bg-success w-full rounded-xl hover:font-bold py-2 px-5 hover:scale-105 text-center"
                  >
                    Document
                  </a>
                </div>
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-8 my-5">
              <div className="flex flex-col w-auto">
                <p className="text-[#015CBA] body-text">Instagram</p>
                <p className="text-[#4F9BFD] small">{row.instagram}</p>
              </div>
              <div className="flex flex-col w-auto">
                <p className="text-[#015CBA] body-text">Youtube</p>
                <p className="text-[#4F9BFD] small">{row.youtube}</p>
              </div>
              <div className="flex flex-col w-auto mr-10">
                <p className="text-[#015CBA] body-text">Twitter</p>
                <p className="text-[#4F9BFD] small">{row.twitter}</p>
              </div>
            </div>
          </div>
        </div>
