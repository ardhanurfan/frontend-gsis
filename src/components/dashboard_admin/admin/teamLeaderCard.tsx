      ...
      <div className="m-2">
        ...
        <div className="w-[240px] h-auto mb-2">
          <div className="small text-[#015CBA] flex gap-1 mb-1">
            <a href={approve.ktm_url} className="hover:underline">
              Student ID Card
            </a>
            ...
            {visible == "WAITING" ? (
              <>
                <button
                  ...
                  onClick={() => {
                    postData("REJECTED", "approve_ktm_leader");
                    setVisible("REJECTED");
                  }}
                >
                  Decline
                ...
                <button
                  ...
                  onClick={() => {
                    postData("ACCEPTED", "approve_ktm_leader");
                    setVisible("ACCEPTED");
                  }}
                >
                  Accept
        ...
        <div className="w-[240px] h-auto mb-2">
          <div className="small text-[#015CBA] flex gap-1 mb-1">
            <a href={approve.ss_follow_url} className="hover:underline">
            ...
            {visible1 == "WAITING" ? (
              <>
                <button
                  className="w-auto bg-error text-white button-text-mobile md:button-text rounded-lg px-2 hover:scale-105"
                  onClick={() => {
                    postData("REJECTED", "approve_follow_leader");
                ...
                <button
                  className="w-auto bg-success text-white button-text-mobile md:button-text rounded-lg px-2 hover:scale-105"
                  onClick={() => {
                    postData("ACCEPTED", "approve_follow_leader");
        ...
        <div className="w-[240px] h-auto mb-2">
          <div className="small text-[#015CBA] flex gap-1 mb-1">
            <a href={approve.ss_poster_url} className="hover:underline">
            ...
            {visible2 == "WAITING" ? (
              <>
                <button
                  className="w-auto bg-error text-white button-text-mobile md:button-text rounded-lg px-2 hover:scale-105"
                  onClick={() => {
                    postData("REJECTED", "approve_poster_leader");
                ...
                <button
                  className="w-auto bg-success text-white button-text-mobile md:button-text rounded-lg px-2 hover:scale-105"
                  onClick={() => {
                    postData("ACCEPTED", "approve_poster_leader");
