...
const Footer = () => {
    return (
        <div className="relative bottom-0 clear-both">
            <div className="custom-shadow px-[5px] lg:px-[35px] flex justify-between items-center w-full h-[50px] bg-slate-100 bg-opacity-20 backdrop-blur-lg mx-auto overflow-hidden border-2 border-white border-opacity-20">
                ...
                <div className="flex gap-[11px] text-primaryBlue">  
                    <a className="text-[22px] lg:text-[28px] justify-end flex items-center text-primaryBlue hover:text-seccondaryBlue" href="https://www.linkedin.com/company/ganesha-student-innovation-summit/">
                        <FaLinkedin/>
                    </a>  
                    <a className="text-[22px] lg:text-[28px] justify-end flex items-center hover:text-seccondaryBlue" href="https://www.instagram.com/ganeshasummit/?hl=en">
                        <FaInstagram/>
                    </a>
                </div>
            </div>
