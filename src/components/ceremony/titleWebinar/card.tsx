...
const TitleWebinarCard = ({ title, name, foto }: TittleWebinarCardProps) => {
  return (
    <div className="w-[90vw] h-[auto] lg:h-[auto] overflow-auto lg:overflow-visible bg-slate-100 bg-opacity-30 rounded-xl mx-auto  lg:mt-10 shadow-lg shadow-blue-300 flex flex-col lg:flex-row gap-[30px] lg:gap-[65px]">
