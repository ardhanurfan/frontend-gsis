  ...
  return (
    <>
      ...
      <div className="w-full h-auto overflow-auto">
        <h1 className="header1-mobile lg:header1 w-[89.744%] max-w-[1204px] mx-auto text-center lg:text-start text-primaryText mt-[130px]">Participant Information</h1>
        <div className="mt-[30px] mx-auto w-[89.744%] max-w-[1204px] border-2 border-primaryBlue rounded-lg p-5 flex flex-col gap-[5px]">
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-[5px]">
              ...
              <p className="small lg:body-text text-primaryBlue">{data.user.name}</p>
            </div>
          ...
          <div className="flex flex-col gap-[5px]">
            ...
            <div>
              <span className="flex gap-2 items-center">
                  <img src={data.stream == 'TECHNOLOGY'? str : data.stream == 'ART' ? art : bus } />
          ...
          <a href="/submission-bcc" className="bg-primaryBlue hover:bg-seccondaryBlue flex justify-center items-center mx-auto w-60 h-[25px] lg:h-[40px] button-text-mobile lg:button-text text-white rounded-lg py-4">
