                ...
                <div className="w-full rounded-[10px] px-6 pt-[30px] pb-12 border border-primaryBlue mb-4">
                    <div className="w-full flex justify-between mb-2">
                        <div className="flex flex-col gap-y-1">
                            ...
                            <p className="body-text-mobile lg:body-text text-seccondaryBlue">{data == null ? "" : data.user.name}</p>
                        </div>
                        <a
                    ...
                    <p className="body-text-mobile lg:small text-seccondaryBlue">Opening Ceremony</p>
                    <p className="body-text-mobile lg:body-text text-primaryText mt-4">Date</p>
                    <p className="body-text-mobile lg:small text-seccondaryBlue">08/07/23 13:00</p>
                    <p className="body-text-mobile lg:body-text text-primaryText mt-4">Link</p>
                    <p className="body-text-mobile lg:small text-seccondaryBlue">TBA</p>
                </div>
            </div>
