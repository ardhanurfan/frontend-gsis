      ...
      <div className="w-full px-[5.3472%] lg:px-[130px] pt-[130px] pb-[100px]">
        ...
        <div className="flex flex-col gap-[106px]">
          <div className="flex flex-col">
            ...
            <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
              <h3 className="header3-mobile lg:header3 text-primaryBlue">Team Leader</h3>
              <label
              ...
              <UploadFile childToParent={(e: File) => setKtmLeader(e)} type={"image"}  />
            </div>
            <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
              <label
                className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
              ...
              <UploadFile childToParent={(e: File) => setPosterLeader(e)} type={"image"}  />
            </div>
            <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
              <label
                className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
              ...
              <UploadFile childToParent={(e: File) => setFollowLeader(e)} type={"image"}  />
            </div>
            <div className="my-[40px] md:w-[70%] lg:w-[60%] xl:w-[50%] mx-auto">
              <form className="lg:w-full" action="">
                ...
                className="field-text text-primaryBlue block mb-[5px]">
                  <h3 className='header3-mobile lg:header3 text-center'>Invite Team Member</h3>
                </label>
                <SelectComponent multiple placeholder="Find Member" type={"Member All"} onChange={(e:any)=>setMember(e)} />
            </form>
          </div>
          </div>
          <div className="flex flex-col lg:flex-row gap-[106px] lg:gap-12 ">
            <div className="flex flex-col w-full mx-auto">
              <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
                <h3 className="header3-mobile lg:header3 text-primaryBlue">First Member</h3>
                <label
                  className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
                  htmlFor=""
                >
                ...
                <UploadFile childToParent={(e: File) => setKtmUser1(e)} type={"image"} />
              </div>
              <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
                <label
                  className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
                ...
                <UploadFile childToParent={(e: File) => setPosterUser1(e)} type={"image"}  />
              </div>
              <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
                <label
                  className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
                ...
                <UploadFile childToParent={(e: File) => setFollowUser1(e)} type={"image"}  />
              </div>
            </div>
            <div className="flex flex-col w-full mx-auto">
              <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
                <h3 className="header3-mobile lg:header3 text-primaryBlue">Second Member</h3>
                <label
                  className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
                  htmlFor=""
                >
                ...
                <UploadFile childToParent={(e: File) => setKtmUser2(e)} type={"image"}  />
              </div>
              <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
                <label
                  className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
                ...
                <UploadFile childToParent={(e: File) => setPosterUser2(e)} type={"image"}  />
              </div>
              <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
                <label
                  className="button-text-mobile lg:button-text mb-2 text-primaryBlue after:content-['*'] after:text-error after:ml-0.5"
                ...
                <UploadFile childToParent={(e: File) => setFollowUser2(e)} type={"image"}  />
              </div>
            </div>
          </div>
          <div className="w-[90%] max-w-sm mx-auto pt-[14px] flex flex-col justify-center">
            ...
            <UploadFile childToParent={(e: File) => setPayment(e)} type={"image"}  />
          </div>
        </div>
