        ...
        <div className="pt-[200px] text-center">
          ...
          <div className="mt-12 w-[70%] max-w-[1300px] mx-auto bg-slate-100 bg-opacity-30 rounded-xl shadow-lg shadow-slate-500 flex flex-col lg:flex-row overflow-hidden">
            <div className="w-full py-5 lg:p-10 flex items-center">
              <p className='px-5 lg:px-20 body-text-mmobile lg:body-text text-primaryText text-center lg:text-justify'>This exhibition is a platform for students and the general public to showcase their work and demonstrate their skills and talents in the fields of art, technology, and business. The purpose of this exhibition is to give visitors the opportunity to gain exposure and also appreciate the works of industry players in these fields.
              </p>
            </div>
          </div>
