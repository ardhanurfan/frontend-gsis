      ...
      <div className="w-[90.3vw] h-[auto] lg:h-[615px] bg-slate-100 mt-[120px] lg:mt-[250px] mx-auto rounded-xl shadow-lg shadow-slate-500 bg-opacity-30 overflow-auto lg:overflow-visible">
        ...
        <div className="lg:pt-[98px] clear-left lg:clear-none">
          ...
          <p className="text-primaryText pb-5 lg:mr-[97px] px-12 lg:px-0 body-text text-justify">
            ...
            incidunt? Enim voluptates, itaque facere minus impedit porro eaque,
            et eos officiis dolorem assumenda ducimus. Itaque possimus natus
            animi doloremque dicta, blanditiis esse odio, nostrum nemo
