    ...
    return (
        ...
        <div className="flex flex-col justify-center py-4 bg-black">
            <div className="w-full flex items-center justify-between pt-[100px] px-40">
                <h1 className="text-7xl font-bold text-left text-[#005CBA] title mb-10">Exhibition Participant</h1>
                <div className="select">
                    <select className="body-text w-auto bg-primaryBlue text-white cursor-pointer outline-none shadow-none border-0 rounded-lg" name="" id="">
                ...
                <div className="grid grid-cols-3 p-2 shadow-2xl rounded-b-xl">
                    ...
                    <div className="col-span-2 rounded-md h-[auto]">
                        <div className="my-5 mr-5">
                            ...
                            <p className="text-[#4F9BFD] small text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam pariatur ratione nesciunt? Nesciunt nostrum aperiam in, unde, odio illo incidunt alias consequatur est laboriosam vel sapiente maxime repudiandae consequuntur id laborum. Incidunt consequatur esse saepe eius, pariatur fuga nemo animi. Corporis a quo repellat, modi totam aliquid nesciunt illum voluptas.</p> 
                        </div>
                    </div>
                </div>
            </details>
