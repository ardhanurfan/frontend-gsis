            ...
            <div className="flex flex-col">
                  ...
                  <label htmlFor="">
                    ...
                    <div className="select relative h-10 lg:h-[50px] flex justify-start w-[250px]">
                      <select
                        ...
                        value={type}
                      >
                        <option className="text-seccondaryBlue" value={""} selected disabled>
                          Choose type
                        </option>
              ...
              <div className="px-20 py-10">
                  <div className=" flex flex-col gap-5 sm:gap-10 sm:flex-row justify-between pt-10 pb-5 w-full h-auto">
                    <div className="">
                      <button className="bg-error w-auto h-auto text-white rounded-lg hover:bg-red-600" onClick={() => {announContext?.setAnnounce(false);announContext?.setDataRow(null)}}>
                        <div className="button-text-mobile lg:button-text p-2 px-5">Cancel</div>
                      </button>
                    </div>
                    <div className="flex flex-row justify-center gap-10">
                      <div className="">
                        <button className="bg-primaryBlue w-auto h-auto text-white rounded-lg shadow-lg hover:bg-seccondaryBlue" onClick={() => postData("DRAFT")}>
                          <div className="button-text-mobile lg:button-text p-2 px-5">Save</div>
                        </button>
                      </div>
                      <div className="">
                        <button className="bg-white w-auto h-auto rounded-lg border-2 border-[#005CBA] text-[#005CBA] shadow-lg hover:bg-slate-300" onClick={() => postData("SENT")}>
