...
const FAQ = () => {
  return (
    <>
      <div className="w-full h-auto bg-[url(./src/assets/Background.svg)] bg-cover">
        <div className="flex flex-col items-center py-4">
          ...
          <div className="mt-9.5 space-y-4">
            <details className="pb-5 hover:cursor-pointer rounded-xl">
              <summary className="w-[1230px] h-[70px] text-lg bg-gradient-to-l from-[#060B81] to-[#005CBA] rounded-xl text-white flex items-center justify-between px-5">
                Lorem ipsum dolor sit amet.
              </summary>
              <p className="w-[1230px] h-[70px] bg-white rounded-b-xl flex items-center justify-between px-5 shadow-lg">
