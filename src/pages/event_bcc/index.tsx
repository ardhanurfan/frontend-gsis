    ...
    <div className="w-full h-auto bg-cover bg-[url(./assets/Background_BCC.svg)]">
      ...
      <div className="w-auto h-auto mx-auto pt-5">
        ...
        <div className="w-auto h-auto mt-20">
          ...
          <div className="w-auto h-auto flex space-x-28 justify-center mt-20">
            <div className="content-center">
              <div className="flex items-center justify-center">
                <img
                  className=""
                  src="../src/assets/bcc_stream_technology.svg"
                  alt="Technology Stream"
                />
              </div>
              <div>
            ...
            <div className="content-center">
              ...
              <div>
                <h3 className="text-center text-primaryBlue header3">Art</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-auto h-auto mt-20 items-center justify-center flex">
          ...
          <div className="text-center w-[714px]">
            <h1 className="w-auto header1 text-primaryText">Are You Ready To Be The Next Winner?</h1>
          </div>
          <div className="flex justify-center items-center mt-10"><Button>Register</Button></div>
          </div>
          <img
                  className=""
        ...
        <div className="w-auto h-auto mt-20">
          <div className="text-center">
            <h1 className="w-auto header1 text-primaryText">Contact Person</h1>
          </div>
        </div>
      </div>
    </div>
